...
class Container:
 ...
 def regLayout(self):
   ...
   lObj[6].grid(row = 3 , column = 0 , sticky=W , pady=(7 , 0) , padx=(0 , 0))
   ...
   rObj[0].grid(row=10 , column=0 , sticky=W , padx=(0 , 0) , pady=(10 , 0))
   rObj[1].grid(row=10 , column=1 , sticky=W , padx=(0 , 0) , pady=(10 , 0))
   rObj[2].grid(row=10 , column=2 , sticky=W , padx=(0 , 0) , pady=(10 , 0))
