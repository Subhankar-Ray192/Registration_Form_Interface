...
title = ["Candidate's details:", "Guardian's details:", "Address:"]
header = ["First Name:", "Middle Name:", "Last Name:", "First Name:", "Middle Name:", "Last Name:", "Postal Code:" , "Country:" ,
          "Contact Number:", "Email:", "Gender:", "Registration Number"]

can_details = ["Candidates Name:", "Guardian's Name: ", "Address: ", "Contact number: ", "Email-id: ", "Gender: ",
               "Registration Status: "]
...
class Container:
    ...
    def regLayout(self):
        ...
        lObj[4].grid(row=6, column=0, sticky=W, pady=(20, 0), padx=(2, 2))

        lObj[5].grid(row=1, column=0, sticky=W, pady=(7, 0), padx=(0, 5))
        lObj[6].grid(row=1, column=1, sticky=W, pady=(7, 0), padx=(0, 5))
        lObj[7].grid(row=1, column=2, sticky=W, pady=(7, 0), padx=(0, 5))

        lObj[8].grid(row=4, column=0, sticky=W, pady=(7, 0), padx=(0, 5))
        lObj[9].grid(row=4, column=1, sticky=W, pady=(7, 0), padx=(0, 5))
        lObj[10].grid(row=4, column=2, sticky=W, pady=(7, 0), padx=(0, 5))
