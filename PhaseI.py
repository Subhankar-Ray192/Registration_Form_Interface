...
fontStyles=[]
header=["Registration Number:","First Name:","Middle Name:","Last Name:","Contact Number:","Gender:","Email:"]
...
class Container:
 ...
 def mas_terminal_by_Tan(self):
   print("You have clicked the master terminal button")
 ...
 def menu(self):
  ...
  m_second.add_command(label=self.menuNm[3] , command=lambda:self.mas_terminal_by_Tan())
 ...
 def layout(self):
   ...
   self.dataEntry.append(StringVar())
   self.eObj.append(Entry(self.fc[1], textvariable=self.dataEntry[0],font="Bitter 10" , highlightbackground=colorPalette[2], highlightthickness=1))
   self.dataEntry.append(StringVar())
   self.eObj.append(Entry(self.fc[1] , textvariable=self.dataEntry[1] , font="Bitter 10" , highlightbackground=colorPalette[2], highlightthickness=1))
   self.dataEntry.append(StringVar())
   self.eObj.append(Entry(self.fc[1] , textvariable=self.dataEntry[2] , font="Bitter 10" , highlightbackground=colorPalette[2], highlightthickness=1))
   self.dataEntry.append(StringVar())
   self.eObj.append(Entry(self.fc[1] , textvariable=self.dataEntry[3] , font="Bitter 10" , highlightbackground=colorPalette[2], highlightthickness=1))
   self.dataEntry.append(StringVar())
   self.eObj.append(Entry(self.fc[1], textvariable = self.dataEntry[4] , font="Bitter 10" , highlightbackground=colorPalette[2], highlightthickness=1))
   
   self.dataEntry.append(StringVar())
   self.dataEntry[5].set("Male")
   rObj.append(Radiobutton(self.fc[1], text="Female" , font="Bitter 10" , bg=colorPalette[0] , variable=self.dataEntry[5] , value="Female"))
   rObj.append(Radiobutton(self.fc[1] , text="Male" , font="Bitter 10" , bg=colorPalette[0], variable=self.dataEntry[5] , value="Male"))
   rObj.append(Radiobutton(self.fc[1] , text="Others" , font="Bitter 10" , bg=colorPalette[0] , variable=self.dataEntry[5] , value="Others"))
   
   self.dataEntry.append(StringVar())
   self.eObj.append(Entry(self.fc[1], textvariable=self.dataEntry[6], font="Bitter 10" , highlightbackground=colorPalette[2], highlightthickness=1))
   
   self.dataEntry.append(IntVar())
   terms_and_conditions = Checkbutton(self.fc[2], text="By clicking on this button you agree to our terms and conditions." , variable=self.dataEntry[7] , bg=colorPalette[0] , font="Bitter 10")
   ...
   rObj[0].grid(row=6 , column=1 , sticky=W , padx=(0 , 0) , pady=(0 , 0))
   
   rObj[1].grid(row=6 , column=2 , sticky=W , padx=(0 , 0) , pady=(0 , 0))
   
   rObj[2].grid(row=6 , column=3 , sticky=W , padx=(0 , 0) , pady=(0 , 0))
   
   lObj[8].grid(row=7 , column=1 , sticky=W , pady=(20 , 0))
   
   self.eObj[5].grid(row=7 , column=2 , sticky=W , pady=(20 , 0) , padx=(5 , 0))

   terms_and_conditions.grid(row=8 , column=1 , pady=(10 , 0))

 def button(self):
  btn=Button(self.fc[3], text="Register" , command=self.register_button , bg=colorPalette[1] , fg=colorPalette[0] , padx=208 , pady=10 , font="Bitter 14")
